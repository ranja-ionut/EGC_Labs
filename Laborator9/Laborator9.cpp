...
void Laborator9::Update(float deltaTimeSeconds)
{
	...
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		auto cameraRotation = GetSceneCamera()->transform->GetWorldRotation();
		modelMatrix = glm::translate(modelMatrix, glm::vec3(0.0f, 0.5f, 0.0f));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f));
		modelMatrix *= glm::toMat4(cameraRotation);
...
void Laborator9::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
	...
	glUniform1i(glGetUniformLocation(shader->program, "isGlobe"), isGlobe);
	...
	if (texture1)
	{
		...
		glUniform1i(glGetUniformLocation(shader->program, "usesTexture2"), 0);
	}
	...
	if (texture2)
	{
		...
		glUniform1i(glGetUniformLocation(shader->program, "usesTexture2"), 1);
	}
